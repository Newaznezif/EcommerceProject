...
if ($row_p_cat !== null && isset($row_p_cat['p_cat_title'])) {
    $p_cat_title = $row_p_cat['p_cat_title'];
} else {
    // Handle the case when $row_p_cat is null or 'p_cat_title' is not set
    // For example, set a default value or log an error message
...
Product Price : <del> ETB $pro_price </del><br>

Product sale Price : ETB $pro_psp_price
...
Bundle Price : <del> ETB $pro_price </del><br>

Bundle sale Price : ETB $pro_psp_price
...
$product_price = "<del> ETB $pro_price </del>";

$product_psp_price = "| ETB $pro_psp_price";
