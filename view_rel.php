...
<button type="button" class="btn btn-danger" onclick="window.location.href='index.php?delete_rel=<?php echo $rel_id; ?>'">
...
<button type="button" class="btn btn-primary" onclick="window.location.href='index.php?edit_rel=<?php echo $rel_id; ?>'">
