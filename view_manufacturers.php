...
<button type="button" class="btn btn-danger" onclick="window.location.href='index.php?delete_manufacturer=<?php echo $manufacturer_id; ?>'">
...
<button type="button" class="btn btn-primary" onclick="window.location.href='index.php?edit_manufacturer=<?php echo $manufacturer_id; ?>'">
